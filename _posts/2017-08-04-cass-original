...
The following Service is used for DNS lookups between Cassandra pods, and Cassandra clients within the Kubernetes Cluster.
...
Running the Cassandra utility nodetool will displaydisplays the status of the ring.
...
The StatefulSet will contain four pods.

kubectl get statefulset cassandra

The command should respond like:

AME        DESIRED   CURRENT   AGE
cassandra   4         4         36m
